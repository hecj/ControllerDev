...
public final class Device {
    ...
    private static Size computeVideoSize(int w, int h, int maxSize) {
        ...
        */
        ...
        // 480p/720p/1080p
        switch (maxSize) {
            case 360: // 480p:640x480 new add by hecj
                newHeight = 360;
                newWidth=(int)((double)h/w*newHeight);
                validSize = true;
                break;
...
//                newWidth = 640;
                ...
                validSize = true;
                break;
            case 640: // 480p:640x480 new add by hecj
                newHeight = 640;
                newWidth=(int)((double)h/w*newHeight);
                validSize = true;
                break;
...
//        int scaledY = contentRect.top + point.y * contentRect.height() / videoSize.getHeight();
        ...
        // hecj todo
//        int scaledX = contentRect.left + point.x * contentRect.width() / 886;
//        int scaledY = contentRect.top + point.y * contentRect.height() / 1794;

        int scaledX = contentRect.left + point.x * contentRect.width() / clientVideoSize.getWidth();
        int scaledY = contentRect.top + point.y * contentRect.height() / clientVideoSize.getHeight();
